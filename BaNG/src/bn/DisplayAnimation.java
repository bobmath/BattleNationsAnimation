...
public class DisplayAnimation {
	...
	public static DisplayAnimation get(String name) throws IOException {
		return new DisplayAnimation(Animation.get(name));
	}
	
	public DisplayAnimation(Animation anim) throws IOException {
		this.anim = anim;
